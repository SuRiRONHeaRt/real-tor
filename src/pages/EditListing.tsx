...
const EditListing = () => {
  ...
  useEffect(() => {
    if (listing && listing.userRef !== auth.currentUser?.uid) {
      toast.error("You ain't the owner of this listing");
      navigate("/");
    }
  ...
  return (
    ...
    font-bold"
      ...
      <form onSubmit={onSubmit}>
        ...
        <p className="tsxt-lg mt-6 font-semibold">Name</p>
        <input
          type="text"
          id="name"
          value={name}
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 text-xl text-gray-700 
                bg-white border-gray-300 trasition 
        ...
        <div>
          <p className="tsxt-lg mt-6 font-semibold">Address</p>
          <textarea
            id="address"
            value={address}
            onChange={onChange}
        ...
        <div className="mb-6">
          ...
          <input
            ...
            multiple
            required
            className="w-full px-3 py-1.6 text-gray-700
              bg-white border border-gray-300 rounded
